...
const PERF_DATA = {
  pnl: [
    ...
    -100,165,-100,60,60,112,62,-100,143,110,96,210,16,118,78,117,-100,
    104,-100,105,21,-100,-100
  ],
  avgOdd: '2.42',
  signals: 88,
  totalPnL: 3582.2
...
const CHART_PATH = "M 58.0 178.6 L 66.3 180.9 L 74.6 176.5 L 82.9 172.7 L 91.2 174.9 L 99.5 171.2 L 107.8 154.3 L 116.1 159.1 L 124.4 152.0 L 132.7 143.3 L 141.0 132.9 L 149.3 135.9 L 157.6 131.3 L 165.9 127.5 L 174.2 129.7 L 182.5 126.4 L 190.8 129.7 L 199.1 126.4 L 207.4 122.2 L 215.7 124.6 L 224.0 127.7 L 232.3 130.5 L 240.6 125.3 L 248.9 129.5 L 257.2 133.8 L 265.5 127.6 L 273.8 125.0 L 282.1 122.4 L 290.4 127.9 L 298.7 131.5 L 307.0 123.3 L 315.3 126.4 L 323.6 121.9 L 331.9 115.3 L 340.2 118.4 L 348.5 116.0 L 356.8 119.1 L 365.1 115.7 L 373.4 112.4 L 381.7 115.7 L 390.0 120.5 L 398.3 116.8 L 406.6 109.8 L 414.9 91.8 L 423.1 94.5 L 431.4 85.2 L 439.7 92.2 L 448.0 96.7 L 456.3 101.1 L 464.6 103.2 L 472.9 94.4 L 481.2 97.2 L 489.5 98.9 L 497.8 95.2 L 506.1 89.1 L 514.4 86.4 L 522.7 89.2 L 531.0 86.3 L 539.3 90.1 L 547.6 87.1 L 555.9 82.9 L 564.2 78.1 L 572.5 71.4 L 580.8 75.3 L 589.1 71.0 L 597.4 74.9 L 605.7 68.5 L 614.0 72.3 L 622.3 70.0 L 630.6 67.7 L 638.9 63.3 L 647.2 60.9 L 655.5 64.8 L 663.8 59.2 L 672.1 55.0 L 680.4 51.2 L 688.7 43.1 L 697.0 42.4 L 705.3 37.9 L 713.6 34.8 L 721.9 30.3 L 730.2 34.2 L 738.5 30.1 L 746.8 34.0 L 755.1 29.9 L 763.4 29.1 L 771.7 33.0 L 780.0 36.9"
const PATH_LENGTH = 839
const LAST_X = 780.0
const LAST_Y = 36.9
const ZERO_Y = 176.1
const Y_TICKS = [{'val': -356, 'y': 190.0}, {'val': 737, 'y': 147.5}, {'val': 1830, 'y': 105.0}, {'val': 2923, 'y': 62.5}, {'val': 4016, 'y': 20.0}]
